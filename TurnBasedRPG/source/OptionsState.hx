...
class OptionsState extends FlxState
{
	...
	override public function create():Void
	{
		...
		volumeDownButton = new FlxButton(8, volumeText.y + volumeText.height + 2, "-",
			clickVolumeDown);
		volumeDownButton.loadGraphic("assets/images/button1.png", true, 20, 20);
		volumeDownButton.onUp.sound = FlxG.sound.load("assets/sounds/select1.wav");
		add(volumeDownButton);

		volumeUpButton = new FlxButton(FlxG.width - 28, volumeDownButton.y, "+", clickVolumeUp);
		volumeUpButton.loadGraphic("assets/images/button1.png", true, 20, 20);
		volumeUpButton.onUp.sound = FlxG.sound.load("assets/sounds/select1.wav");
		add(volumeUpButton);
		...
		clearDataButton = new FlxButton((FlxG.width / 2) - 90, FlxG.height - 28, "Clear Data",
			clickClearData);
		clearDataButton.onUp.sound = FlxG.sound.load("assets/sounds/select1.wav");
		add(clearDataButton);

		backButton = new FlxButton((FlxG.width / 2) + 10, FlxG.height - 28, "Back", clickBack);
		backButton.onUp.sound = FlxG.sound.load("assets/sounds/select1.wav");
		add(backButton);
