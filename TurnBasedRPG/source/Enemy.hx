...
class Enemy extends FlxSprite
{
	...
	public function new(x:Float, y:Float, type:EnemyType)
	{
		...
		{
			case GOLEM:
				graphic = "assets/images/Golem.png";
			case DRAGON:
				graphic = "assets/images/Dragon.png";
			case SIREN:
				graphic = "assets/images/Siren.png";
			case SYLPH:
				graphic = "assets/images/Sylph.png";
		}
		//var graphic = if (type == GOLEM) "assets/images/Golem.png" else "assets/images/Dragon.png";
		...
		stepSound = FlxG.sound.load("assets/sounds/step1.wav", 0.4);
